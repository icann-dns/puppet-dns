...
# @param default_max_refresh_time Maximum refresh interval for zones
# @param default_min_refresh_time Minimum refresh interval for zones
...
class dns (
  ...
  Optional[Integer[1]]          $default_max_refresh_time = undef,
  Optional[Integer[1]]          $default_min_refresh_time = undef,
  Optional[Integer[1]]          $default_max_retry_time   = undef,
  Optional[Integer[1]]          $default_min_retry_time   = undef,
  Optional[Integer[1]]          $default_min_expire_time  = undef,
) {
  ...
  if $ensure == 'present' {
    if $daemon == 'opendnssec' {
      ...
      class { 'nsd':
        ...
        imports                  => $imports,
        exports                  => $exports,
        default_max_refresh_time => $default_max_refresh_time,
        default_min_refresh_time => $default_min_refresh_time,
        default_max_retry_time   => $default_max_retry_time,
        default_min_retry_time   => $default_min_retry_time,
        default_min_expire_time  => $default_min_expire_time,
      }
      class { 'knot':
        enable                       => $knot_enable,
        ip_addresses                 => $ip_addresses,
        ...
        imports                      => $imports,
        exports                      => $exports,
        default_refresh_min_interval => $default_min_refresh_time,
        default_refresh_max_interval => $default_max_refresh_time,
        default_retry_min_interval   => $default_min_retry_time,
        default_retry_max_interval   => $default_max_retry_time,
        default_expire_min_interval  => $default_min_expire_time,
      }
